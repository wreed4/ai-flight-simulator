...
echo "Fixing THREE.RGBFormat deprecation warning..."

# Update the Engine.js file to use THREE.RGBAFormat instead of the deprecated THREE.RGBFormat
...
echo "THREE.RGBFormat deprecation fixed. Run 'npm start' to test the changes."
